...
<!-- Soft shadow -->
<img src="../../images/client-timesheet.png" alt="Client Timesheet" style="border-radius: 10px; width: 70%; height: 70%; box-shadow: 0 0 20px rgba(0, 0, 0, 0.1); border: 5px solid #333;">
